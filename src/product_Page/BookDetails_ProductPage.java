...
public class BookDetails_ProductPage extends BaseScreen {
	...
	@FindBy(xpath="//*[@id='mediaTab_heading_1']//span[@class='a-size-base mediaTab_subtitle'] | //*[@id='a-autoid-3-announce']/span[2]/span")
	...
	@FindBy(xpath="//*[@id='mediaTab_heading_0']//span[@class='a-size-base mediaTab_subtitle'] | //*[@id='a-autoid-2-announce']/span[2]/span")
	...
	public void getEdition_ProductPage(){
		...
		try{
			if(bookEdition_ProductPage.isDisplayed()){
				...
				System.out.println("Edition is not provided");
			}
		}
		catch(Exception e){
			System.out.println("Error: Edition is not provided");
		}
	}
